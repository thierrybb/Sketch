...
import ca.etsmtl.sketch.graphic.util.EventLogger;
import ca.etsmtl.sketch.graphic.util.UserContext;
...
public class MultitouchSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void init() {
        ...
        userContext = new UserContext(drawing);

        gw.setFontHeight(Constant.TEXT_HEIGHT);
    }

    public void processMultitouchInputEvent(int id, float x, float y, int type) {
        userContext.processMultitouchInputEvent(id, x, y, type, gw,
                this, false);
    }
...
//        gw.setCoordinateSystemToPixels();
    ...
    public void setColor(int i) {
        userContext.setCurrent_color(i);
    }
