...
import ca.etsmtl.sketch.surface.shape.FingerCursorShape;

public class InkModeTouchComponent {
    private Drawing drawing;

    private HashMap<Integer, FingerCursorShape> allShapesForFinger = new HashMap<Integer, FingerCursorShape>();
    private EventBus bus;

    public InkModeTouchComponent(Drawing drawing) {
    ...
    public void onFingerDown(OnFingerDownInkMode event) {
        FingerCursorShape newShape = new FingerCursorShape(event.getPosition());
